...
extern const LEX_STRING PROC_DUMMY_SCHEMA;
...
class Sql_cmd_proc_dummy : public Sql_cmd_admin_proc {
 public:
  explicit Sql_cmd_proc_dummy(THD *thd, List<Item> *list, const Proc *proc)
...
class Proc_dummy : public Proc {
 ...
 public:
  ...
  virtual const std::string str() const { return std::string("dummy"); }
};
...
class Sql_cmd_proc_dummy_2 : public Sql_cmd_admin_proc {
 public:
  explicit Sql_cmd_proc_dummy_2(THD *thd, List<Item> *list, const Proc *proc)
      : Sql_cmd_admin_proc(thd, list, proc) {}
...
class Proc_dummy_2 : public Proc {
 ...
 public:
  ...
  virtual const std::string str() const { return std::string("dummy_2"); }
};
} /* namespace im */
