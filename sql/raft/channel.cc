...
/** Special channel name for raft channel. */
const char *Multisource_info::raft_channel = "xpaxos_applier";

/** Whether channel is raft replication according to channel name. */
bool Multisource_info::is_raft_replication_channel_name(const char *channel) {
