...
bool show_consensuslog_events(THD *thd, MYSQL_BIN_LOG *binary_log, unsigned long long consensus_index)
{
...
@retval TRUE failure
*/
bool mysql_show_consensuslog_events(THD* thd, unsigned long long consensus_index)
{
