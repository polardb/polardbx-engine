...
namespace im {
extern LEX_CSTRING XA_PROC_SCHEMA;
...
class Sql_cmd_xa_proc_base : public Sql_cmd_trans_proc {
 public:
  explicit Sql_cmd_xa_proc_base(THD *thd, List<Item> *list, const Proc *proc)
...
class Sql_cmd_xa_proc_find_by_gtrid : public Sql_cmd_xa_proc_base {
 public:
  explicit Sql_cmd_xa_proc_find_by_gtrid(THD *thd, List<Item> *list,
                                       const Proc *proc)
...
class Xa_proc_find_by_gtrid : public Xa_proc_base {
  ...
  */
  ...
  /* Proc name */
  virtual const std::string str() const { return std::string("find_by_gtrid"); }
};
...
class Sql_cmd_xa_proc_send_heartbeat : public Sql_cmd_xa_proc_trans_base {
 public:
  explicit Sql_cmd_xa_proc_send_heartbeat(THD *thd, List<Item> *list,
                                          const Proc *proc)
...
class Sql_cmd_xa_proc_advance_gcn_no_flush : public Sql_cmd_xa_proc_trans_base {
 public:
  explicit Sql_cmd_xa_proc_advance_gcn_no_flush(THD *thd, List<Item> *list,
                                                const Proc *proc)
      : Sql_cmd_xa_proc_trans_base(thd, list, proc) {}
