...
extern ulonglong smart_handle_dup_key;
extern ulonglong smart_handle_no_key;
extern ulonglong smart_handle_failed;
...
extern PSI_stage_info stage_wait_for_cn_heartbeat;
