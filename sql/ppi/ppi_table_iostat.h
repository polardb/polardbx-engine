...
#ifndef PPI_PPI_TABLE_IOSTAT_H_INCLUDED
#define PPI_PPI_TABLE_IOSTAT_H_INCLUDED
...
extern ST_FIELD_INFO table_iostat_fields_info[];

/* Fill the io statistic rows */
extern int fill_schema_table_iostat(THD *thd, Table_ref *tables,
