...
*/
extern LEX_CSTRING TSO_PROC_SCHEMA;
...
class Proc_get_timestamp : public Tso_proc_base {
 public:
  ...
  virtual const std::string str() const { return std::string("get_timestamp"); }
};
...
class Cmd_get_timestamp : public Sql_cmd_admin_proc {
 public:
  explicit Cmd_get_timestamp(THD *thd, List<Item> *list, const Proc *proc)
