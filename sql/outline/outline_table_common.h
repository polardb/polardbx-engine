...
struct Outline_record : public Conf_record {
 ...
 public:
  ...
  virtual bool check_valid(const char **msg) const;
  /**
  ...
  */
  ...
  virtual ulonglong get_id() const { return id; }
  virtual void set_id(ulonglong value) { id = value; }
  virtual bool check_active() const {
