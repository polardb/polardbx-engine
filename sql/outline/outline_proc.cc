...
*/
Sql_cmd *Outline_optimizer_proc_add::evoke_cmd(THD *thd,
...
*/
Sql_cmd *Outline_index_proc_add::evoke_cmd(THD *thd, List<Item> *list) const {
  return new (thd->mem_root) Sql_cmd_type(thd, list, this);
}
...
*/
Sql_cmd *Outline_proc_del::evoke_cmd(THD *thd, List<Item> *list) const {
  return new (thd->mem_root) Sql_cmd_type(thd, list, this);
}
...
*/
Sql_cmd *Outline_proc_flush::evoke_cmd(THD *thd, List<Item> *list) const {
  return new (thd->mem_root) Sql_cmd_type(thd, list, this);
}
...
*/
Sql_cmd *Outline_proc_show::evoke_cmd(THD *thd, List<Item> *list) const {
  return new (thd->mem_root) Sql_cmd_type(thd, list, this);
}
...
*/
Sql_cmd *Outline_proc_preview::evoke_cmd(THD *thd, List<Item> *list) const {
  return new (thd->mem_root) Sql_cmd_type(thd, list, this);
}
/**
...
static bool outline_compute_digest(THD *thd, Outline_record *record,
  ...
  DBUG_ASSERT(!blank(record->query));
