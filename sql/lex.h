...
static const SYMBOL symbols[] = {
    ...
    */
    ...
    {SYM("XPAXOS_REPLICATION", XPAXOS_REPLICATION)},
    {SYM("YEAR", YEAR_SYM)},
    ...
    */
    {SYM_H("BKA", BKA_HINT)},
    {SYM_H("BNL", BNL_HINT)},
    {SYM_H("CCL_QUEUE_FIELD", CCL_QUEUE_FIELD_HINT)},
    {SYM_H("CCL_QUEUE_VALUE", CCL_QUEUE_VALUE_HINT)},
    {SYM_H("SAMPLE_PERCENTAGE", SAMPLE_PERCENTAGE_HINT)},
    {SYM_H("COMMIT_ON_SUCCESS", COMMIT_ON_SUCCESS_HINT)},
    {SYM_H("ROLLBACK_ON_FAIL", ROLLBACK_ON_FAIL_HINT)},
    {SYM_H("TARGET_AFFECT_ROW", TARGET_AFFECT_ROW_HINT)},
