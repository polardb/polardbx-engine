...
class Lex_returning {
 public:
  explicit Lex_returning(bool is_returning_stmt);
  ...
  List<Item> *get_fields() { return &m_items; };
...
class Update_returning_statement {
 public:
  ...
  /**
    ...
    @retval         true          failure
  */
  bool itemize_fields(THD *thd, List<Item> &fields, SELECT_LEX *select_lex);
  ...
  /**
    ...
    @retval         true          failure
  */
  bool setup(THD *thd, SELECT_LEX *select_lex);
