...
public:
  explicit Sql_cmd_changeset_proc(THD *thd, List<Item> *list, const Proc *proc)
...
public:
  explicit Sql_cmd_changeset_proc_start(THD *thd, List<Item> *list, const Proc *proc)
...
public:
  ...
  virtual const std::string str() const { return std::string("changeset_start"); }
};
...
public:
  explicit Sql_cmd_changeset_proc_fetch(THD *thd, List<Item> *list, const Proc *proc)
      : Sql_cmd_changeset_proc(thd, list, proc) {}
...
public:
  explicit Sql_cmd_changeset_proc_finish(THD *thd, List<Item> *list, const Proc *proc)
      : Sql_cmd_changeset_proc(thd, list, proc) {}
...
public:
  ...
  virtual const std::string str() const { return std::string("changeset_finish"); }
};
...
public:
  explicit Sql_cmd_changeset_proc_stop(THD *thd, List<Item> *list, const Proc *proc)
      : Sql_cmd_changeset_proc(thd, list, proc) {}
...
public:
  ...
  virtual const std::string str() const { return std::string("changeset_stop"); }
};
...
public:
  explicit Sql_cmd_changeset_proc_stats(THD *thd, List<Item> *list, const Proc *proc)
      : Sql_cmd_changeset_proc(thd, list, proc) {}
...
public:
  ...
  virtual const std::string str() const { return std::string("changeset_stats"); }
};
...
public:
  explicit Sql_cmd_changeset_proc_times(THD *thd, List<Item> *list, const Proc *proc)
      : Sql_cmd_changeset_proc(thd, list, proc) {}
...
public:
  ...
  virtual const std::string str() const { return std::string("changeset_times"); }
};
}
