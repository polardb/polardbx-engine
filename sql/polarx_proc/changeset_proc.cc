...
Sql_cmd *Changeset_proc_start::evoke_cmd(THD *thd, mem_root_deque<Item *> *list) const {
...
Sql_cmd *Changeset_proc_fetch::evoke_cmd(THD *thd, mem_root_deque<Item *> *list) const {
  return new(thd->mem_root) Sql_cmd_type(thd, list, this);
}
...
void Sql_cmd_changeset_proc_fetch::send_result(THD *thd, bool error) {
  ...
  if (!changes.empty()) {
    ...
    if ((dynamic_cast<const Changeset_proc_fetch *>(m_proc))->my_send_result_metadata(thd, m_columns, begin.second->pk_field_list)) return;
  } else {
    // send result
    if (m_proc->send_result_metadata(thd)) return;
  }
...
Sql_cmd *Changeset_proc_finish::evoke_cmd(THD *thd, mem_root_deque<Item *> *list) const {
  return new(thd->mem_root) Sql_cmd_type(thd, list, this);
}
...
Sql_cmd *Changeset_proc_stop::evoke_cmd(THD *thd, mem_root_deque<Item *> *list) const {
  return new(thd->mem_root) Sql_cmd_type(thd, list, this);
}
...
Sql_cmd *Changeset_proc_stats::evoke_cmd(THD *thd, mem_root_deque<Item *> *list) const {
  return new(thd->mem_root) Sql_cmd_type(thd, list, this);
}
...
Sql_cmd *Changeset_proc_times::evoke_cmd(THD *thd, mem_root_deque<Item *> *list) const {
  return new(thd->mem_root) Sql_cmd_type(thd, list, this);
}
...
bool Sql_cmd_changeset_proc::check_access(THD *) {
  return false;
}
