...
class Ccl_comply_handler {
 public:
  explicit Ccl_comply_handler(THD *thd) :
      m_thd(thd),
      m_complied(false) {};

 public:
  void comply_rule(enum_sql_command sql_command, TABLE_LIST *all_tables,
...
void do_ccl_comply_queue_or_rule(THD *thd, LEX *lex, TABLE_LIST *table_list);
