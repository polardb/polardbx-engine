...
public:
  ...
  */
  template <uint32_t field_id> void encode_field_bool(const bool value) {
  ...
  */
  ...
  void encode_optional_field_var_uint32(const uint32_t *value) {
    if (value)
      encode_field_var_uint32<field_id>(*value);
  }
  ...
  */
  ...
  void encode_optiona_field_var_sint32(const int32_t *value) {
    if (value)
      encode_field_var_sint32<field_id>(*value);
  }
  ...
  */
  ...
  void encode_optional_field_var_uint64(const uint64_t *value) {
    if (value)
      encode_field_var_uint64<field_id>(*value);
  }
  ...
  */
  ...
  void encode_optional_field_var_sint64(const int64_t *value) {
    if (value)
      encode_field_var_sint64<field_id>(*value);
  }
  ...
  */
  ...
  /**
    ...
    how long field entry is going to be generated by `field_id`).
  */
  template <uint32_t field_id> void encode_field_enum(const int32_t value) {
    assert(value >= 0);
  ...
  */
  ...
  void encode_optional_field_enum(const int32_t *value) {
    if (value)
      encode_field_enum<field_id>(*value);
  }
  ...
  /**
    ...
    how long field entry is going to be generated by `field_id`).
  */
  template <uint32_t field_id, int64_t value> void encode_field_const_enum() {
  ...
  */
  template <uint32_t field_id> void encode_field_delimited_header() {
    encode_const_var_uint<Helper::encode_field_tag(
  ...
  */
  ...
  /**
    ...
    user doesn't need to call `ensure_buffer_size`.
  */
  template <uint32_t field_id> void encode_field_string(const char *value) {
    encode_field_delimited_raw<field_id>(
