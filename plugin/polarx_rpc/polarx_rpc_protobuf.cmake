# Copyright (c) 2015, 2016, Oracle and/or its affiliates. Copyright (c) 2023, 2024, Alibaba and/or its affiliates. All rights reserved.
#
...
IF (MSVC)
    SET(POLARX_RPC_PROTOBUF_MSVC_DISABLED_WARNINGS "/wd4267 /wd4244")
ENDIF ()

# Standard PROTOBUF_GENERATE_CPP modified to generate both
# protobuf and protobuf-lite C++ files.
FUNCTION(POLARX_RPC_PROTOBUF_GENERATE_CPP SRCS HDRS SRCS_LITE HDRS_LITE)
    IF (NOT ARGN)
        MESSAGE(SEND_ERROR
                "Error: POLARX_RPC_PROTOBUF_GENERATE_CPP() called without any proto files")
        RETURN()
    ENDIF ()
    ...
    FOREACH (FIL ${ARGN})
        ...
        # message(STATUS "build proto ${FIL_WE} to ${CMAKE_CURRENT_BINARY_DIR}")
        ...
        ADD_CUSTOM_COMMAND(
                ...
                ${PROTOBUF_PROTOC_EXECUTABLE} GenLiteProtos_polarx_rpc
    ...
    IF (MSVC)
        ADD_COMPILE_FLAGS(${${SRCS}} ${${SRCS_LITE}}
                COMPILE_FLAGS ${POLARX_RPC_PROTOBUF_MSVC_DISABLED_WARNINGS})
    ENDIF ()
...
FUNCTION(POLARX_RPC_PROTOBUF_GENERATE_CPP_NAMES SRC_NAMES)
    IF (NOT ARGN)
        MESSAGE(SEND_ERROR
                "Error: POLARX_RPC_PROTOBUF_GENERATE_CPP_NAMES() called without any proto files")
        RETURN()
    ENDIF ()
    ...
    FOREACH (FIL ${ARGN})
        ...
        LIST(APPEND ${SRC_NAMES}
                "${CMAKE_BINARY_DIR}/plugin/polarx_rpc/protobuf/${FIL_WE}.pb.cc")
    ENDFOREACH ()
