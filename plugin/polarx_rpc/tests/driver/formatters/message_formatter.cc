...
static std::string messages_field_to_text(const Message &message,
  ...
  switch (fd->cpp_type()) {
    case FieldDescriptor::CPPTYPE_INT32:
      return polarx_rpc::to_string(reflection->GetInt32(message, fd));

    case FieldDescriptor::CPPTYPE_UINT32:
      return polarx_rpc::to_string(reflection->GetUInt32(message, fd));

    case FieldDescriptor::CPPTYPE_INT64:
      return polarx_rpc::to_string(reflection->GetInt64(message, fd));

    case FieldDescriptor::CPPTYPE_UINT64:
      return polarx_rpc::to_string(reflection->GetUInt64(message, fd));

    case FieldDescriptor::CPPTYPE_DOUBLE:
      return polarx_rpc::to_string(reflection->GetDouble(message, fd));

    case FieldDescriptor::CPPTYPE_FLOAT:
      return polarx_rpc::to_string(reflection->GetFloat(message, fd));

    case FieldDescriptor::CPPTYPE_BOOL:
      return polarx_rpc::to_string(reflection->GetBool(message, fd));
