...
static MYSQL_SYSVAR_ULONG(buffer_size,
    ...
    NULL, audit_log_buffer_size_update, 8 * 1024 * 1024UL, 0, ULONG_MAX, 1);
...
static MYSQL_SYSVAR_ULONG(row_limit,
    ...
    "above this number.",
    NULL, audit_log_row_limit_update, 100000, 0, ULONG_MAX, 1);
...
static MYSQL_SYSVAR_BOOL(flush,
    ...
    "file will be created.", NULL, rds_audit_log_flush_update, 0);
...
static MYSQL_SYSVAR_BOOL(enabled,
    ...
    NULL, rds_audit_log_enabled_update, 0);
...
static TYPELIB audit_log_strategy_typelib = {
    array_elements(log_strategy_names) - 1, "", log_strategy_names, NULL};
...
static MYSQL_SYSVAR_ENUM(strategy,
    ...
    NULL, audit_log_strategy_update, MYSQL_RDS_AUDIT_LOG::ASYNCHRONOUS,
...
static TYPELIB audit_log_policy_typelib = {
    array_elements(log_policy_names) - 1, "", log_policy_names, NULL};
...
static MYSQL_SYSVAR_ENUM(policy,
    ...
    "and 'NONE'.",
    NULL, audit_log_policy_update, MYSQL_RDS_AUDIT_LOG::LOG_ALL,
...
static TYPELIB audit_log_connection_policy_typelib = {
    ...
    log_connection_policy_names, NULL};
...
static MYSQL_SYSVAR_ENUM(connection_policy,
    ...
    "and 'NONE'.",
    NULL, audit_log_connection_policy_update, MYSQL_RDS_AUDIT_LOG::CONN_ALL,
...
static TYPELIB audit_log_statement_policy_typelib = {
    ...
    log_statement_policy_names, NULL};
...
static MYSQL_SYSVAR_ENUM(statement_policy,
    ...
    NULL, audit_log_statement_policy_update, MYSQL_RDS_AUDIT_LOG::STMT_ALL,
