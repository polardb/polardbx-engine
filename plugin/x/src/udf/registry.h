...
#ifndef PLUGIN_X_SRC_UDF_REGISTRY_H_
...
class Registry {
 public:
  using Record = Registrator::Record;
  using Name_registry = Registrator::Name_registry;
 ...
 private:
  Name_registry m_function_names;
};

}  // namespace udf
}  // namespace xpl

#endif  // PLUGIN_X_SRC_UDF_REGISTRY_H_
