...
ngs::Listener_interface_ptr Galaxy_listener_factory::create_tcp_socket_listener(
  ...
  return ngs::Listener_interface_ptr(ngs::allocate_object<Galaxy_listener_tcp>(
