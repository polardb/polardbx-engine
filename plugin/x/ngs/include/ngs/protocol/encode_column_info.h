...
#ifndef PLUGIN_X_NGS_INCLUDE_NGS_PROTOCOL_ENCODE_COLUMN_INFO_H_
#define PLUGIN_X_NGS_INCLUDE_NGS_PROTOCOL_ENCODE_COLUMN_INFO_H_
...
#endif  // PLUGIN_X_NGS_INCLUDE_NGS_PROTOCOL_ENCODE_COLUMN_INFO_H_
