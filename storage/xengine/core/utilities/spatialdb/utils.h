...
#include "xengine/utilities/spatial_db.h"
...
inline BoundingBox<uint64_t> GetTileBoundingBox(
    const util::spatial::SpatialIndexOptions& spatial_index,
...
// big endian can be compared using memcpy
inline bool GetFixed64BigEndian(const common::Slice& input, uint64_t* value) {
...
inline bool GetDouble(common::Slice* input, double* d) {
