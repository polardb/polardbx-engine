...
void OptimisticTransactionImpl::Clear() { TransactionBaseImpl::Clear(); }
...
Status OptimisticTransactionImpl::CommitAsync(AsyncCallback* call_back) {
  return Status::NotSupported(
      "OptimisticTransactionImpl not "
      "Support CommitAsync(AsyncCallback* call_back");
}
