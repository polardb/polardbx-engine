...
#ifndef ROCKSDB_LITE
#include "xengine/utilities/table_properties_collectors.h"
namespace xengine {
namespace util {
...
class CompactOnDeletionCollector : public table::TablePropertiesCollector {
 public:
  ...
  virtual table::UserCollectedProperties GetReadableProperties()
      const override {
    return table::UserCollectedProperties();
  }
