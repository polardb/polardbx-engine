...
//
// GranularLockImpl
// Thread safe custom implementation of hash table with granular locking
...
int main(int argc, char** argv) {
  ...
  {
    util::SimpleImpl impl;
    util::HashTableBenchmark _(&impl, FLAGS_nsec, FLAGS_nthread_write,
