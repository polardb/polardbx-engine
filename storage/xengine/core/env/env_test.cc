...
TEST_P(EnvPosixTestWithParam, LogBufferTest) {
  ...
  ROCKS_LOG_BUFFER(&log_buffer, "\7%s\7", bytes200);
  ROCKS_LOG_BUFFER(&log_buffer, "\7%s\7", bytes600);
  ROCKS_LOG_BUFFER(&log_buffer, "\7%s\7%s\7%s\7", bytes200, bytes200, bytes200);
  ROCKS_LOG_BUFFER(&log_buffer, "\7%s\7%s\7", bytes200, bytes600);
  ROCKS_LOG_BUFFER(&log_buffer, "\7%s\7%s\7", bytes600, bytes9000);

  ROCKS_LOG_BUFFER(&log_buffer_debug, "\7%s\7", bytes200);
  test_logger.SetInfoLogLevel(DEBUG_LEVEL);
  ROCKS_LOG_BUFFER(&log_buffer_debug, "\7%s\7%s\7%s\7", bytes600, bytes9000,
                   bytes200);
