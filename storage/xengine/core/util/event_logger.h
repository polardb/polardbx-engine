...
class EventLoggerStream {
 ...
 private:
  ...
  explicit EventLoggerStream(LogBuffer* log_buffer = nullptr);
...
class EventLogger {
 public:
  ...
  static EventLoggerStream GetLoggerStream(LogBuffer* log_buffer = nullptr) {
    return EventLoggerStream(log_buffer);
  }
  static void Log(const JSONWriter& jwriter);
