...
Status BlockBasedTableFactory::NewTableReader(
  ...
  Status s = BlockBasedTable::Open(
      table_reader_options.ioptions, table_reader_options.env_options,
      table_options_, table_reader_options.internal_comparator, std::move(file_ptr),
      file_size, &table_reader_ptr, prefetch_index_and_filter_in_cache,
      table_reader_options.skip_filters, table_reader_options.level);
  table_reader = table_reader_ptr.release();
  return s;
}
