...
int PlainTableBuilder::Add(const Slice& key, const Slice& value) {
  ...
  NotifyCollectTableCollectorsOnAdd(
      key, value, offset_, table_properties_collectors_);
