...
#pragma comment(linker, "/INCLUDE:p_xengine_init_jemalloc")
...
extern const CRT_Startup_Routine p_xengine_init_jemalloc;
const CRT_Startup_Routine p_xengine_init_jemalloc = port::InitializeJemalloc;
#pragma const_seg()
...
#pragma comment(linker, "/INCLUDE:_p_xengine_init_jemalloc")

#pragma section(".CRT$XCT", read)
JEMALLOC_SECTION(".CRT$XCT")
JEMALLOC_ATTR(used) static const
    void(WINAPI* p_xengine_init_jemalloc)(void) = port::InitializeJemalloc;
