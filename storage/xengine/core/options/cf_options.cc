...
void MutableCFOptions::Dump() const {
  ...
  __XENGINE_LOG(INFO,
                 ...
                 write_buffer_size);
  __XENGINE_LOG(INFO, "                     flush_delete_percent: %d",
                 flush_delete_percent);
  __XENGINE_LOG(INFO, "                compaction_delete_percent: %d",
                 compaction_delete_percent);
  __XENGINE_LOG(INFO, "             flush_delete_percent_trigger: %d",
                 flush_delete_percent_trigger);
  __XENGINE_LOG(INFO, "              flush_delete_record_trigger: %d",
                 flush_delete_record_trigger);
  __XENGINE_LOG(INFO, "                  max_write_buffer_number: %d",
                 max_write_buffer_number);
  __XENGINE_LOG(INFO,
                 "                         arena_block_size: %" ROCKSDB_PRIszt,
                 arena_block_size);
  __XENGINE_LOG(INFO, "              memtable_prefix_bloom_ratio: %f",
  ...
  __XENGINE_LOG(INFO, "                 disable_auto_compactions: %d",
                 disable_auto_compactions);
  __XENGINE_LOG(INFO, "      soft_pending_compaction_bytes_limit: %" PRIu64,
                 soft_pending_compaction_bytes_limit);
  __XENGINE_LOG(INFO, "      hard_pending_compaction_bytes_limit: %" PRIu64,
                 hard_pending_compaction_bytes_limit);
  __XENGINE_LOG(INFO, "       level0_file_num_compaction_trigger: %d",
                 level0_file_num_compaction_trigger);
  __XENGINE_LOG(INFO, "      level0_layer_num_compaction_trigger: %d",
                 level0_layer_num_compaction_trigger);
  __XENGINE_LOG(INFO, "                        minor_window_size: %d",
                 minor_window_size);
  __XENGINE_LOG(INFO, "  level1_extents_major_compaction_trigger: %d",
                 level1_extents_major_compaction_trigger);
  __XENGINE_LOG(INFO, "                     level2_usage_percent: %ld",
                 level2_usage_percent);
  __XENGINE_LOG(INFO, "           level0_slowdown_writes_trigger: %d",
                 level0_slowdown_writes_trigger);
  __XENGINE_LOG(INFO, "               level0_stop_writes_trigger: %d",
                 level0_stop_writes_trigger);
  __XENGINE_LOG(INFO, "                     max_compaction_bytes: %" PRIu64,
                 max_compaction_bytes);
  __XENGINE_LOG(INFO, "                    target_file_size_base: %" PRIu64,
                 target_file_size_base);
  __XENGINE_LOG(INFO, "              target_file_size_multiplier: %d",
                 target_file_size_multiplier);
  __XENGINE_LOG(INFO, "                 max_bytes_for_level_base: %" PRIu64,
                 max_bytes_for_level_base);
  __XENGINE_LOG(INFO, "           max_bytes_for_level_multiplier: %f",
  ...
  __XENGINE_LOG(INFO, "max_bytes_for_level_multiplier_additional: %s",
                 result.c_str());
  __XENGINE_LOG(INFO, "        max_sequential_skip_in_iterations: %" PRIu64,
                 max_sequential_skip_in_iterations);
  __XENGINE_LOG(INFO, "                     paranoid_file_checks: %d",
                 paranoid_file_checks);
  __XENGINE_LOG(INFO, "                       report_bg_io_stats: %d",
                 report_bg_io_stats);
  __XENGINE_LOG(INFO, "                              compression: %d",
                 static_cast<int>(compression));
  __XENGINE_LOG(INFO, "                    scan_add_blocks_limit: %" PRIu64,
                 scan_add_blocks_limit);
  __XENGINE_LOG(INFO, "                         bottommost_level: %d", bottommost_level);
  __XENGINE_LOG(INFO, "            compaction_task_extents_limit: %d", compaction_task_extents_limit);
}
