...
class Slice {
 public:
  ...
  //assign buf and buf_size, caller should promise buf and size valid
  ...
  // copy Slice's buffer use allocated new memory.
  Slice deep_copy(memory::Allocator& allocator) const;
  Slice deep_copy(memory::ArenaAllocator& allocator) const;
  Slice deep_copy(memory::SimpleAllocator& allocator) const;
