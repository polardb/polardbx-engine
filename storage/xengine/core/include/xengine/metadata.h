...
struct SstFileMetaData {
  ...
  SstFileMetaData(const std::string& _file_name, const std::string& _path,
                  uint64_t _size, common::SequenceNumber _smallest_seqno,
                  common::SequenceNumber _largest_seqno,
  ...
  common::SequenceNumber smallest_seqno;  // Smallest sequence number in file.
  common::SequenceNumber largest_seqno;   // Largest sequence number in file.
