...
#include "xengine/utilities/lua/rocks_lua_custom_library.h"
#include "xengine/utilities/lua/rocks_lua_util.h"
...
// functions.
class RocksLuaCompactionFilter : public CompactionFilter {
 public:
