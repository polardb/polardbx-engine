...
#include "xengine/utilities/ldb_cmd_execute_result.h"
...
class LDBCommand {
 public:
  ...
  // Consider using xengine::common::Slice::DecodeHex directly instead if you
  // don't need the
  // 0x prefix
  static std::string HexToString(const std::string& str);

  // Consider using xengine::common::Slice::ToString(true) directly instead if
