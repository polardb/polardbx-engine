...
class DateTieredDB {
 public:
  ...
  static common::Status Open(const common::Options& options,
                             const std::string& dbname, DateTieredDB** dbptr,
