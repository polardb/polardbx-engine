...
class LogFile {
 public:
  ...
  virtual common::SequenceNumber StartSequence() const = 0;
...
struct BatchResult {
  common::SequenceNumber sequence = 0;
  std::unique_ptr<WriteBatch, memory::ptr_destruct_delete<WriteBatch>> writeBatchPtr;
...
class TransactionLogIterator {
 public:
  ...
  virtual common::Status status() = 0;
