...
class CompactionFilter {
 public:
  ...
  virtual bool FilterMergeOperand(int level, const common::Slice& key,
                                  const common::Slice& operand) const {
    return false;
  }
  ...
  // MergeOperator.
  virtual Decision FilterV2(int level, const common::Slice& key,
