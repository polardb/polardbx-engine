...
/** @file include/lizard0trx0rec0clover.h
 Clover layout transaction undo log record.

 Created 2024-10-31 by Yichang Song
 *******************************************************/

#ifndef lizard0trx0rec0clover_h
#define lizard0trx0rec0clover_h
...
*/
extern byte *trx_undo_update_rec_get_clover_cols(const byte *ptr,
                                                 txn_info_t *txn_info);
