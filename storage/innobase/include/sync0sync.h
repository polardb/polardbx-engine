...
extern mysql_pfs_key_t txn_undo_space_rseg_mutex_key;
...
extern mysql_pfs_key_t trx_sys_group_mutex_key;
extern mysql_pfs_key_t trx_sys_group_shard_mutex_key;
