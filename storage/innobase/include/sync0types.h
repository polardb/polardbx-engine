...
enum latch_level_t {
  ...
  SYNC_PAGE_CLEANER,
  SYNC_TRX_SYS_HEADER,
  SYNC_TRX_SYS_GTIDS_MEM,
  SYNC_PURGE_QUEUE,
  SYNC_THREADS,
  SYNC_TRX_SYS_GROUP,
  SYNC_TRX_SYS_GROUP_SHARD,
  SYNC_TRX,
  SYNC_POOL,
  SYNC_POOL_MANAGER,
  SYNC_TRX_SYS_SHARD,
...
enum latch_id_t {
  ...
  LATCH_ID_TRX_SYS_GROUP,
  LATCH_ID_TRX_SYS_GROUP_SHARD,
  LATCH_ID_TRX_SYS_GTIDS_MEM,
  LATCH_ID_SRV_SYS,
  ...
  LATCH_ID_SCN_LIST,
  LATCH_ID_GCN_ORDER,
  LATCH_ID_GCN_PERSIST,
  LATCH_ID_UNDO_HDR_HASH,
