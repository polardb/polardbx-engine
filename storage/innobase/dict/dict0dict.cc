...
const char *dict_sys_t::s_default_undo_space_name_1 = "innodb_undo_005";
const char *dict_sys_t::s_default_undo_space_name_2 = "innodb_undo_006";
                           ...
                           in constraints which reference it */
{
  ...
  if (dict_table_is_discarded(table)) {
    ...
    err = fil_delete_tablespace(table->space, BUF_REMOVE_NONE, nullptr);
...
void DDTableBuffer::create_tuples() {
  ...
  byte *scn_buf;
  byte *gcn_buf;
  txn_desc_t *txn_desc = &lizard::txn_sys_t::instance()->txn_desc_dm;
  ...
  lizard::trx_write_scn(scn_buf, txn_desc);
  ...
  lizard::trx_write_undo_ptr(undo_buf, txn_desc);
  ...
  lizard::trx_write_gcn(gcn_buf, txn_desc);
