/* Copyright (c) 2002, 2022, Oracle and/or its affiliates. Copyright (c) 2023, 2024, Alibaba and/or its affiliates.
...
static void test_client_endpoint_ip() {
  ...
  DIE_UNLESS(lmysql);
  /* put in an attr */
  rc = mysql_options4(lmysql, MYSQL_OPT_CONNECT_ATTR_ADD, "_endpoint_ip",
                      "42.42.42.42");
  DIE_UNLESS(!rc);
  if (!mysql_real_connect(lmysql, opt_host, opt_user, opt_password,
                          opt_db ? opt_db : "test", opt_port, opt_unix_socket,
