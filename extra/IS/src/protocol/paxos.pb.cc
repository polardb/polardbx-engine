...
ClusterInfoEntry::ClusterInfoEntry(const ClusterInfoEntry& from)
  ...
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&serverid_, &from.serverid_,
    static_cast<size_t>(reinterpret_cast<char*>(&loginstance_) -
    reinterpret_cast<char*>(&serverid_)) + sizeof(loginstance_));
...
// @@protoc_insertion_point(message_clear_start:alisql.ClusterInfoEntry)
  ...
  if (cached_has_bits & 0x00003f00u) {
    ::memset(&pipelining_, 0, static_cast<size_t>(
        ...
        reinterpret_cast<char*>(&pipelining_)) + sizeof(loginstance_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
}
    ...
    switch (tag >> 3) {
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 96)) {
          ...
          applythreadrunning_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 104)) {
          ...
          disableelection_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 112)) {
          ...
          loginstance_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ClusterInfoEntry::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000400u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64ToArray(11, this->_internal_applydelayseconds(), target);
  }

  // optional uint32 applyThreadRunning = 12;
  if (cached_has_bits & 0x00000800u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(12, this->_internal_applythreadrunning(), target);
  }

  // optional uint32 disableElection = 13;
  if (cached_has_bits & 0x00001000u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(13, this->_internal_disableelection(), target);
  }

  // optional uint32 logInstance = 14;
  if (cached_has_bits & 0x00002000u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(14, this->_internal_loginstance(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:alisql.ClusterInfoEntry)
  ...
  if (cached_has_bits & 0x00003f00u) {
    ...
    // optional uint64 applyDelaySeconds = 11;
    if (cached_has_bits & 0x00000400u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt64SizePlusOne(this->_internal_applydelayseconds());
    }

    // optional uint32 applyThreadRunning = 12;
    if (cached_has_bits & 0x00000800u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_applythreadrunning());
    }

    // optional uint32 disableElection = 13;
    if (cached_has_bits & 0x00001000u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_disableelection());
    }

    // optional uint32 logInstance = 14;
    if (cached_has_bits & 0x00002000u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_loginstance());
    }
...
void ClusterInfoEntry::InternalSwap(ClusterInfoEntry* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ClusterInfoEntry, loginstance_)
      + sizeof(ClusterInfoEntry::loginstance_)
...
PaxosMsg::PaxosMsg(const PaxosMsg& from)
  ...
  ::memcpy(&configid_, &from.configid_,
    static_cast<size_t>(reinterpret_cast<char*>(&loginstance_) -
    reinterpret_cast<char*>(&configid_)) + sizeof(loginstance_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&loginstance_) -
    reinterpret_cast<char*>(&compressedentries_)) + sizeof(loginstance_));
}
