...
class ClusterInfoEntry final :
 ...
 public:
  ...
  enum : int {
    ...
    kApplyDelaySecondsFieldNumber = 11,
    kApplyThreadRunningFieldNumber = 12,
    kDisableElectionFieldNumber = 13,
    kLogInstanceFieldNumber = 14,
  };
  ...
  // optional uint64 applyDelaySeconds = 11;
  bool has_applydelayseconds() const;
  private:
  bool _internal_has_applydelayseconds() const;
  public:
  void clear_applydelayseconds();
  uint64_t applydelayseconds() const;
  void set_applydelayseconds(uint64_t value);
  private:
  uint64_t _internal_applydelayseconds() const;
  void _internal_set_applydelayseconds(uint64_t value);
  public:

  // optional uint32 applyThreadRunning = 12;
  bool has_applythreadrunning() const;
  private:
  bool _internal_has_applythreadrunning() const;
  public:
  void clear_applythreadrunning();
  uint32_t applythreadrunning() const;
  void set_applythreadrunning(uint32_t value);
  private:
  uint32_t _internal_applythreadrunning() const;
  void _internal_set_applythreadrunning(uint32_t value);
  public:

  // optional uint32 disableElection = 13;
  bool has_disableelection() const;
  private:
  bool _internal_has_disableelection() const;
  public:
  void clear_disableelection();
  uint32_t disableelection() const;
  void set_disableelection(uint32_t value);
  private:
  uint32_t _internal_disableelection() const;
  void _internal_set_disableelection(uint32_t value);
  public:

  // optional uint32 logInstance = 14;
  bool has_loginstance() const;
  private:
  bool _internal_has_loginstance() const;
  public:
  void clear_loginstance();
  uint32_t loginstance() const;
  void set_loginstance(uint32_t value);
  private:
  uint32_t _internal_loginstance() const;
  void _internal_set_loginstance(uint32_t value);
  public:
 ...
 private:
  ...
  uint32_t applythreadrunning_;
  uint32_t disableelection_;
  uint32_t loginstance_;
  friend struct ::TableStruct_paxos_2eproto;
};
// -------------------------------------------------------------------
...
class PaxosMsg final :
 ...
 public:
  ...
  public:
  void clear_applythreadrunning();
  bool applythreadrunning() const;
  void set_applythreadrunning(bool value);
  private:
  bool _internal_applythreadrunning() const;
  void _internal_set_applythreadrunning(bool value);
  public:
  ...
  public:
  void clear_disableelection();
  bool disableelection() const;
  void set_disableelection(bool value);
  private:
  bool _internal_disableelection() const;
  void _internal_set_disableelection(bool value);
  public:
  ...
  public:
  void clear_loginstance();
  bool loginstance() const;
  void set_loginstance(bool value);
  private:
  bool _internal_loginstance() const;
  void _internal_set_loginstance(bool value);
  public:
...
// optional uint64 applyDelaySeconds = 11;
inline bool ClusterInfoEntry::_internal_has_applydelayseconds() const {
  bool value = (_has_bits_[0] & 0x00000400u) != 0;
  return value;
}
inline bool ClusterInfoEntry::has_applydelayseconds() const {
  return _internal_has_applydelayseconds();
}
inline void ClusterInfoEntry::clear_applydelayseconds() {
  applydelayseconds_ = uint64_t{0u};
  _has_bits_[0] &= ~0x00000400u;
}
inline uint64_t ClusterInfoEntry::_internal_applydelayseconds() const {
  return applydelayseconds_;
}
inline uint64_t ClusterInfoEntry::applydelayseconds() const {
  // @@protoc_insertion_point(field_get:alisql.ClusterInfoEntry.applyDelaySeconds)
  return _internal_applydelayseconds();
}
inline void ClusterInfoEntry::_internal_set_applydelayseconds(uint64_t value) {
  _has_bits_[0] |= 0x00000400u;
  applydelayseconds_ = value;
}
inline void ClusterInfoEntry::set_applydelayseconds(uint64_t value) {
  _internal_set_applydelayseconds(value);
  // @@protoc_insertion_point(field_set:alisql.ClusterInfoEntry.applyDelaySeconds)
}

// optional uint32 applyThreadRunning = 12;
inline bool ClusterInfoEntry::_internal_has_applythreadrunning() const {
  bool value = (_has_bits_[0] & 0x00000800u) != 0;
  return value;
}
inline bool ClusterInfoEntry::has_applythreadrunning() const {
  return _internal_has_applythreadrunning();
}
inline void ClusterInfoEntry::clear_applythreadrunning() {
  applythreadrunning_ = 0u;
  _has_bits_[0] &= ~0x00000800u;
}
inline uint32_t ClusterInfoEntry::_internal_applythreadrunning() const {
  return applythreadrunning_;
}
inline uint32_t ClusterInfoEntry::applythreadrunning() const {
  // @@protoc_insertion_point(field_get:alisql.ClusterInfoEntry.applyThreadRunning)
  return _internal_applythreadrunning();
}
inline void ClusterInfoEntry::_internal_set_applythreadrunning(uint32_t value) {
  _has_bits_[0] |= 0x00000800u;
  applythreadrunning_ = value;
}
inline void ClusterInfoEntry::set_applythreadrunning(uint32_t value) {
  _internal_set_applythreadrunning(value);
  // @@protoc_insertion_point(field_set:alisql.ClusterInfoEntry.applyThreadRunning)
}

// optional uint32 disableElection = 13;
inline bool ClusterInfoEntry::_internal_has_disableelection() const {
  bool value = (_has_bits_[0] & 0x00001000u) != 0;
  return value;
}
inline bool ClusterInfoEntry::has_disableelection() const {
  return _internal_has_disableelection();
}
inline void ClusterInfoEntry::clear_disableelection() {
  disableelection_ = 0u;
  _has_bits_[0] &= ~0x00001000u;
}
inline uint32_t ClusterInfoEntry::_internal_disableelection() const {
  return disableelection_;
}
inline uint32_t ClusterInfoEntry::disableelection() const {
  // @@protoc_insertion_point(field_get:alisql.ClusterInfoEntry.disableElection)
  return _internal_disableelection();
}
inline void ClusterInfoEntry::_internal_set_disableelection(uint32_t value) {
  _has_bits_[0] |= 0x00001000u;
  disableelection_ = value;
}
inline void ClusterInfoEntry::set_disableelection(uint32_t value) {
  _internal_set_disableelection(value);
  // @@protoc_insertion_point(field_set:alisql.ClusterInfoEntry.disableElection)
}

// optional uint32 logInstance = 14;
inline bool ClusterInfoEntry::_internal_has_loginstance() const {
  bool value = (_has_bits_[0] & 0x00002000u) != 0;
  return value;
}
inline bool ClusterInfoEntry::has_loginstance() const {
  return _internal_has_loginstance();
}
inline void ClusterInfoEntry::clear_loginstance() {
  loginstance_ = 0u;
  _has_bits_[0] &= ~0x00002000u;
}
inline uint32_t ClusterInfoEntry::_internal_loginstance() const {
  return loginstance_;
}
inline uint32_t ClusterInfoEntry::loginstance() const {
  // @@protoc_insertion_point(field_get:alisql.ClusterInfoEntry.logInstance)
  return _internal_loginstance();
}
inline void ClusterInfoEntry::_internal_set_loginstance(uint32_t value) {
  _has_bits_[0] |= 0x00002000u;
  loginstance_ = value;
}
inline void ClusterInfoEntry::set_loginstance(uint32_t value) {
  _internal_set_loginstance(value);
  // @@protoc_insertion_point(field_set:alisql.ClusterInfoEntry.logInstance)
}
...
inline uint64_t PaxosMsg::applydelayseconds() const {
  // @@protoc_insertion_point(field_get:alisql.PaxosMsg.applyDelaySeconds)
  return _internal_applydelayseconds();
}
...
inline void PaxosMsg::set_applydelayseconds(uint64_t value) {
  _internal_set_applydelayseconds(value);
  // @@protoc_insertion_point(field_set:alisql.PaxosMsg.applyDelaySeconds)
}
...
inline bool PaxosMsg::applythreadrunning() const {
  // @@protoc_insertion_point(field_get:alisql.PaxosMsg.applyThreadRunning)
  return _internal_applythreadrunning();
}
...
inline void PaxosMsg::set_applythreadrunning(bool value) {
  _internal_set_applythreadrunning(value);
  // @@protoc_insertion_point(field_set:alisql.PaxosMsg.applyThreadRunning)
}
...
inline bool PaxosMsg::disableelection() const {
  // @@protoc_insertion_point(field_get:alisql.PaxosMsg.disableElection)
  return _internal_disableelection();
}
...
inline void PaxosMsg::set_disableelection(bool value) {
  _internal_set_disableelection(value);
  // @@protoc_insertion_point(field_set:alisql.PaxosMsg.disableElection)
}
...
inline bool PaxosMsg::loginstance() const {
  // @@protoc_insertion_point(field_get:alisql.PaxosMsg.logInstance)
  return _internal_loginstance();
}
