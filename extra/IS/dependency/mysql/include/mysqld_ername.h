...
{ "ER_LAST_MYSQL_ERROR_MESSAGE", 1882, "\"" },
{ "ER_SERVER_THREAD_RUNNING_TOO_HIGH", 3000, "MySQL Sever is too busy." },
{ "ER_QUERY_TIMEOUT", 3001, "Query execution was interrupted, max_statement_time exceeded" },
{ "ER_UNMATCH_AFFECTED_ROWS", 3002, "The affected row number does not match that of user specified." },
{ "ER_BLOB_KEY_WITH_COMPRESS", 3003, "Compressed BLOB/TEXT/VARCHAR/VARBINARY column \'%-.192s\' used in key list is not allowed" },
{ "ER_DEFINED_COMPRESS_COLUMN", 3004, "Can not define column \'%-.192s\' in compressed format, silently change column_format to default" },
