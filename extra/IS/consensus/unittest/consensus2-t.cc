...
TEST(consensus, paxos_group_send)
{
  ...
  *(entries.Add())= le;
  ...
  std::cout<< "countMsgAppendLog:"<<stats.countMsgAppendLog<< " countMsgRequestVote:"<<stats.countMsgRequestVote<< " countOnMsgAppendLog:"<< stats.countOnMsgAppendLog<< " countHeartbeat:"<< stats.countHeartbeat << " countOnMsgRequestVote:"<<stats.countOnMsgRequestVote<< " countOnHeartbeat:"<<stats.countOnHeartbeat<< " countReplicateLog:"<<stats.countReplicateLog<< std::endl<< std::flush;
  EXPECT_EQ(stats.countOnMsgAppendLog - (stats.countOnHeartbeat - last_countOnHeartbeat), last_countOnMsgAppendLog + 2);
  ...
  *(entries.Add())= le;
  ...
  std::cout<< "countMsgAppendLog:"<<stats.countMsgAppendLog<< " countMsgRequestVote:"<<stats.countMsgRequestVote<< " countOnMsgAppendLog:"<< stats.countOnMsgAppendLog<< " countHeartbeat:"<< stats.countHeartbeat << " countOnMsgRequestVote:"<<stats.countOnMsgRequestVote<< " countOnHeartbeat:"<<stats.countOnHeartbeat<< " countReplicateLog:"<<stats.countReplicateLog<< std::endl<< std::flush;
  EXPECT_EQ(stats.countOnMsgAppendLog - (stats.countOnHeartbeat - last_countOnHeartbeat), last_countOnMsgAppendLog + 3);
  ...
  *(entries.Add())= le;
  ...
  std::cout<< "countMsgAppendLog:"<<stats.countMsgAppendLog<< " countMsgRequestVote:"<<stats.countMsgRequestVote<< " countOnMsgAppendLog:"<< stats.countOnMsgAppendLog<< " countHeartbeat:"<< stats.countHeartbeat << " countOnMsgRequestVote:"<<stats.countOnMsgRequestVote<< " countOnHeartbeat:"<<stats.countOnHeartbeat<< " countReplicateLog:"<<stats.countReplicateLog<< std::endl<< std::flush;
  EXPECT_EQ(stats.countOnMsgAppendLog - (stats.countOnHeartbeat - last_countOnHeartbeat), last_countOnMsgAppendLog + 5);
  ...
  *(entries.Add())= le;
  ...
  std::cout<< "countMsgAppendLog:"<<stats.countMsgAppendLog<< " countMsgRequestVote:"<<stats.countMsgRequestVote<< " countOnMsgAppendLog:"<< stats.countOnMsgAppendLog<< " countHeartbeat:"<< stats.countHeartbeat << " countOnMsgRequestVote:"<<stats.countOnMsgRequestVote<< " countOnHeartbeat:"<<stats.countOnHeartbeat<< " countReplicateLog:"<<stats.countReplicateLog<< std::endl<< std::flush;
  EXPECT_EQ(stats.countOnMsgAppendLog - (stats.countOnHeartbeat - last_countOnHeartbeat), last_countOnMsgAppendLog + 7);
