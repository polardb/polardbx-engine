...
TEST(consensus, paxos_one_node)
{
  ...
  learner1->initAsLearner(strTmp1);
  ...
  auto config= std::dynamic_pointer_cast<StableConfiguration>(paxos1->getConfig());
  EXPECT_EQ(config->learnersToString(), std::string("127.0.0.1:11002$00;127.0.0.1:11003$00"));
  ...
  EXPECT_EQ(config->membersToString(("127.0.0.1:11001")), std::string("127.0.0.1:11001#5N;127.0.0.1:11002#5N;127.0.0.1:11003#5N@1"));
  ...
  auto config2= std::dynamic_pointer_cast<StableConfiguration>(learner1->getConfig());
  EXPECT_EQ(config2->learnersToString(), std::string(""));
  EXPECT_EQ(config2->membersToString(("127.0.0.1:11002")), std::string("127.0.0.1:11001#5N;127.0.0.1:11002#5N;127.0.0.1:11003#5N@2"));
...
TEST(consensus, largeBatchMode)
{
  ...
  std::cout<< "countMsgAppendLog:"<<stats1.countMsgAppendLog<< " countMsgRequestVote:"<<stats1.countMsgRequestVote<< " countOnMsgAppendLog:"<< stats1.countOnMsgAppendLog<< " countHeartbeat:"<< stats1.countHeartbeat << " countOnMsgRequestVote:"<<stats1.countOnMsgRequestVote<< " countOnHeartbeat:"<<stats1.countOnHeartbeat<< " countReplicateLog:"<<stats1.countReplicateLog<< std::endl<< std::flush;
