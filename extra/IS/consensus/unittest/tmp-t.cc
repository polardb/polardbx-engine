 ...
 * $Id:  tmp-t.cc,v 1.0 02/16/2017 10:29:00 AM yingqiang.zyq(yingqiang.zyq@alibaba-inc.com) $
 *
 ************************************************************************/
...
TEST(Service, ThreadTimer_weight_repeat)
{
  ...
  ThreadTimer *tt3= new ThreadTimer(tts, 10.0, ThreadTimer::Stage, []{std::cout<< "foo3"<< std::endl << std::flush;ttsCalled.fetch_add(1);});
  tt3->setRandWeight(5);
  tt3->start();
...
TEST(consensus, paxos_learner_restart)
{
  ...
  auto config= std::dynamic_pointer_cast<StableConfiguration>(learner2->getConfig());
  EXPECT_EQ(config->learnersToString(), std::string("127.0.0.1:11002$00;127.0.0.1:11003$00;127.0.0.1:11004$00;127.0.0.1:11005$00;127.0.0.1:11006$00;127.0.0.1:11007$00;127.0.0.1:11008$00"));
  ...
  sleep(1);
  EXPECT_EQ(config->learnersToString(), std::string("127.0.0.1:11002$00;127.0.0.1:11003$00;127.0.0.1:11004$00;0;127.0.0.1:11006$00;127.0.0.1:11007$00;127.0.0.1:11008$00"));
  ...
  paxos1->changeLearners(Paxos::CCDelNode, strConfig);
  sleep(1);
  EXPECT_EQ(config->learnersToString(), std::string("127.0.0.1:11002$00;127.0.0.1:11003$00;127.0.0.1:11004$00;0;0;127.0.0.1:11007$00;127.0.0.1:11008$00"));
  ...
  paxos1->changeLearners(Paxos::CCDelNode, strConfig);
  sleep(1);
  EXPECT_EQ(config->learnersToString(), std::string("127.0.0.1:11002$00;127.0.0.1:11003$00;0;0;0;127.0.0.1:11007$00;127.0.0.1:11008$00"));
...
TEST(consensus, stability)
{
  ...
  /* config change (sometimes config change will cause leaderTransfer check fail) */
