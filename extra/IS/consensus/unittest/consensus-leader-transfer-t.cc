 ...
 * $Id:  consensus-leader-transfer-t.cc,v 1.0 07/31/2019 16:23:00 PM aili.xp(aili.xp@alibaba-inc.com) $
 *
 ************************************************************************/
...
TEST(LeaderTransfer, UnnecessaryLog)
{
  ...
  std::shared_ptr<PaxosLog> rlog1= std::make_shared<FilePaxosLog>(dir1, FilePaxosLog::LogType::LTMem);
  Paxos *paxos1= new Paxos(timeout, rlog1);
  paxos1->init(strConfig, 1);
  std::string dir2 = std::string("paxosLogTestDir72");
  std::shared_ptr<PaxosLog> rlog2= std::make_shared<FilePaxosLog>(dir2, FilePaxosLog::LogType::LTMem);
  Paxos *paxos2= new Paxos(timeout, rlog2);
  paxos2->init(strConfig, 2);
  std::string dir3 = std::string("paxosLogTestDir73");
  std::shared_ptr<PaxosLog> rlog3= std::make_shared<FilePaxosLog>(dir3, FilePaxosLog::LogType::LTMem);
...
{
  public:
    PaxosLogTmp(const std::string &dataDir, FilePaxosLog::LogTypeT type):FilePaxosLog(dataDir, type) {}
    virtual ~PaxosLogTmp() { }
...
TEST(LeaderTransfer, AutoLeaderTransfer)
{
  ...
  std::string dir1 = std::string("paxosLogTestDir71");
  std::shared_ptr<PaxosLog> rlog1= std::make_shared<PaxosLogTmp>(dir1, FilePaxosLog::LogType::LTMem);
  Paxos *paxos1= new Paxos(timeout, rlog1);
  paxos1->init(strConfig, 1);
  std::string dir2 = std::string("paxosLogTestDir72");
  std::shared_ptr<PaxosLog> rlog2= std::make_shared<PaxosLogTmp>(dir2, FilePaxosLog::LogType::LTMem);
  Paxos *paxos2= new Paxos(timeout, rlog2);
  paxos2->init(strConfig, 2);
  std::string dir3 = std::string("paxosLogTestDir73");
  std::shared_ptr<PaxosLog> rlog3= std::make_shared<PaxosLogTmp>(dir3, FilePaxosLog::LogType::LTMem);
  Paxos *paxos3= new Paxos(timeout, rlog3);
  paxos3->init(strConfig, 3);
