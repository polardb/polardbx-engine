...
TEST(consensus, may_read_mock_log)
{
   ...
   * paxos1 became leader in term 2, maxDelayIndex is 2, paxos2/paxos3 became disable pipeling mode
   * We should make sure leader will not read the mock log in this case.
   */
