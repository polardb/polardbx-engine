...
namespace alisql {
  // Wait until the paxos instance has replicated log entry with specified log index,
  // using pooling with a timeout default to 30 seconds.
  static bool waitUntilLogReplicatedWithIndex(Paxos *paxos, uint index, uint timeout = 30)
  {
