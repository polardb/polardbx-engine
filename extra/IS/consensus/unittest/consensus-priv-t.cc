...
TEST(consensus, Paxos_forceSync_replica)
{
  ...
  EXPECT_EQ(tmpStr, std::string("127.0.0.1:11001#5N;127.0.0.1:11002#5N;127.0.0.1:11003#5N@2"));
  ...
  tmpStr.clear();
  rlog2->getMetaData(std::string(Paxos::keyMemberConfigure), tmpStr);
  EXPECT_EQ(tmpStr, std::string("127.0.0.1:11001#5N;127.0.0.1:11002#5N;127.0.0.1:11003#6F@2"));
...
TEST(consensus, Paxos_weight_election)
{
  ...
  tmpStr.clear();
  rlog2->getMetaData(std::string(Paxos::keyMemberConfigure), tmpStr);
  EXPECT_EQ(tmpStr, std::string("127.0.0.1:11001#9N;127.0.0.1:11002#5N;127.0.0.1:11003#5N@2"));
  ...
  EXPECT_EQ(tmpStr, std::string("127.0.0.1:11001#5N;127.0.0.1:11002#5N;127.0.0.1:11003#0N@1"));
...
TEST(consensus, Paxos_weight_election_live)
{
  ...
  tmpStr.clear();
  rlog2->getMetaData(std::string(Paxos::keyMemberConfigure), tmpStr);
  EXPECT_EQ(tmpStr, std::string("127.0.0.1:11001#1N;127.0.0.1:11002#9N;127.0.0.1:11003#5N@2"));
  std::vector<Paxos::ClusterInfoType> cis;
  paxos1->getClusterInfo(cis);
  Paxos::printClusterInfo(cis);
