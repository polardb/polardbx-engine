 ...
 * $Id:  consensus-leader-degrade-t.cc,v 1.0 07/15/2019 14:03:00 PM aili.xp(aili.xp@alibaba-inc.com) $
 *
 ************************************************************************/
...
{
  public:
    TestFilePaxosLog(const std::string &dataDir):FilePaxosLog(dataDir), delay(0) { }
...
// OptimisticHeartbeat make sure that leader will not degrade if follower response
// to heartbeat too slow
