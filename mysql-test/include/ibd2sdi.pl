...
sub ibd2sdi_replace() {
  ...
  while(<IN_FILE>) {
    ...
    $_=~ s/("se_private_data":) "gcn=[0-9]+;id=[0-9]+;page_type=[0-9]+;root=[0-9]+;scn=[0-9]+;space_id=[0-9]+;table_id=[0-9]+;trx_id=[0-9]+;uba=[0-9]+;"/$1 "gcn=F;id=A;page_type=G;root=B;space_id=C;table_id=D;trx_id=E"/g;
